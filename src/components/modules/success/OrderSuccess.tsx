        ...
        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
                <Link href="/shop" className="flex-1">
                    <Button className="w-full h-14 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-2xl font-bold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity">
                        <ShoppingBag size={20} /> Continue Shopping
                    </Button>
                </Link>
                <Button
                    variant="outline"
                    className="flex-1 h-14 border-slate-200 dark:border-slate-800 rounded-2xl font-bold flex items-center justify-center gap-2 dark:text-white"
