...
export default function CartPage() {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-10 transition-colors duration-300 pb-32 lg:pb-10">
            ...
            <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800 p-4 px-6 z-50 shadow-[0_-10px_30px_rgba(0,0,0,0.1)]">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <Link href="/checkout" className="w-full">
                        <Button className="flex-1 h-14 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-2xl text-lg font-bold shadow-lg flex items-center justify-center gap-2">
