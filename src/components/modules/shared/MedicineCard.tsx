...
//                     <Button
//                         size="sm"
//                         className="w-10 bg-gradient-to-r from-blue-600 to-green-600 text-white p-3.5 rounded-xl font-black text-lg shadow-xl active:scale-95 disabled:grayscale flex justify-center items-center transition-all"
//                     >
//                         <ShoppingCart className="w-4 h-4 mr-2 group-hover/btn:animate-bounce from-blue-600 to-green-600" />
//                         Add
//                     </Button>
//                 </div>
//             </div>
